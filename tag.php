...
// Get the user's preferred layout for TAGS
$layout_type = get_theme_mod( 'tag_layout_type', 'masonry' );
...
<main id="primary" class="site-main container">
    ...
    <header class="archive-header" style="text-align:center; margin-bottom:60px;">
        <span style="font-family:'Blacksword', serif; color:var(--wedding-accent); font-size:2rem;">Tagged Collection</span>
        <h1 class="entry-title" style="font-size:3.5rem; margin-top:10px;">#<?php single_tag_title(); ?></h1>
    ...
    <?php else : 
        ...
        <?php else : ?>
            <p style="text-align:center; padding:100px 0;">No images found for this tag.</p>
        <?php endif; ?>
