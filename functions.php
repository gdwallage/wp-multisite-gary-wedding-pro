...
function gary_send_performance_headers() {
    ...
    header( "Link: <{$template_uri}/style.css?ver=1.160.0>; rel=preload; as=style", false );
}
add_action( 'send_headers', 'gary_send_performance_headers' );

function gary_wedding_scripts() { wp_enqueue_style( 'gary-wedding-style', get_stylesheet_uri(), array(), '1.160.0' ); }
